...
@section('css')
{{ HTML::style('assets/libs/jQueryFileUpload/css/jquery.fileupload.css') }}
<!-- Bootstrap styles -->
<link rel="stylesheet" href="//netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css">
<!-- Generic page styles -->
<link rel="stylesheet" href="assets/libs/jQueryFileUpload/css/style.css">
<!-- blueimp Gallery styles -->
<link rel="stylesheet" href="http://blueimp.github.io/Gallery/css/blueimp-gallery.min.css">
<!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
<link rel="stylesheet" href="assets/libs/jQueryFileUpload/css/jquery.fileupload.css">
...
<script src="assets/libs/jQueryFileUpload/js/vendor/jquery.ui.widget.js"></script>
...
<script src="assets/libs/jQueryFileUpload/js/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="assets/libs/jQueryFileUpload/js/jquery.fileupload.js"></script>
<!-- The File Upload processing plugin -->
<script src="assets/libs/jQueryFileUpload/js/jquery.fileupload-process.js"></script>
<!-- The File Upload image preview & resize plugin -->
<script src="assets/libs/jQueryFileUpload/js/jquery.fileupload-image.js"></script>
<!-- The File Upload audio preview plugin -->
<script src="assets/libs/jQueryFileUpload/js/jquery.fileupload-audio.js"></script>
<!-- The File Upload video preview plugin -->
<script src="assets/libs/jQueryFileUpload/js/jquery.fileupload-video.js"></script>
...
<script id="template-download" type="text/x-tmpl">
    ...
    <a href="{%=file.url%}" title="{%=file.name%}" download="{%=file.name%}" data-gallery><img width='60' src="{%=file.thumbnailUrl%}"></a>
    {% } %}
    </span>
    </td>
    <td>
    ...
    <td>
    {% if (file.downloadUrl) { %}
    <a href='{%=file.downloadUrl%}' class="btn btn-success">
